        ...
        <section className="py-6">
            ...
            <div className="container">
                <div className="row justify-content-lg-between py-8">
                    <div className="col-6 col-sm-6 col-lg-auto mb-3">
                ...
                <div className="row flex-center">
                    <div className="col-auto my-4">
                        <ul className="list-unstyled list-inline">
                            <li className="list-inline-item me-3"><a className="text-decoration-none" target="_blank" href="https://www.facebook.com/neuroinformatics">
                            ...
                            <li className="list-inline-item me-3"><a target="_blank" href="https://www.instagram.com/neuro_informatics/">
                ...
                <div className="row justify-content-center pb-5">
                    ...
                    <p className="mb-0 fs--1 text-white my-2 text-center">&copy; This template is made with&nbsp;
